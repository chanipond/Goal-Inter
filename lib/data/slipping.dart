...
class PrefSlip {
  ...
  @override
  String toString() {
    return 'PrefSlip(id_booking: $id_booking, id: $id, firstname: $firstname, lastname: $lastname, datetime_start: $datetime_start, datetime_end: $datetime_end, typeField: $typeField, slip: $slip, price: $price)';
  }
