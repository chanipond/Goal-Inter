...
class AdminInfor_service extends StatefulWidget {
  const AdminInfor_service({Key? key}) : super(key: key);

  @override
  State<AdminInfor_service> createState() => _AdminInfor_serviceState();
}

class _AdminInfor_serviceState extends State<AdminInfor_service> {
  bool load = true;
  bool? havedata;
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      //         context,
                      //         MaterialPageRoute(
                      //           builder: (context) => EditInfor_Service(
